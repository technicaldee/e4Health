...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="address" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Your Address')); ?></label>
...
unset($__errorArgs, $__bag); ?>" name="phone" value="<?php echo e(old('phone')); ?>" required autocomplete="phone">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="datetime-local" name="dob" class="form-control">
                            </div>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <?php if(!isset($_GET['doctor'])): ?>
                                <a href="?doctor"> Register as Doctor </a>
                            <?php else: ?>
                                <a href="?"> Register as Patient </a>
                            <?php endif; ?>
                            </div>
                        </div>
                    </form>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\uddy\e4health\resources\views/auth/register.blade.php ENDPATH**/ ?>